  ...
  return (
    ...
    <div className="w-full px-4 py-2 md:px-6 md:py-4 min-h-full flex flex-col rounded-lg overflow-hidden bg-white">
      <div className="mb-8">
          ...
          {user && (
            ...
            <div className="md:w-3/4 w-full border border-gray-200 rounded-lg overflow-scroll md:overflow-hidden">
              <div className="flex justify-between items-center bg-gray-100 border-gray-300 px-4 py-3 border-b">
                <div className="md:w-1/3 text-black text-xs md:text-md">Name</div>
                <div className="md:w-1/3 text-black text-xs md:text-md">{user.name}</div>
              ...
              <div className="flex justify-between items-center px-4 py-3 border-b">
                <div className="text-black md:w-1/3 text-xs md:text-md">User Name</div>
                <div className="text-black md:w-1/3 text-xs md:text-md">{user.username}</div>
                {/* <div className="w-1/3"></div> */}
              </div>
               <div className="flex justify-between bg-gray-100 border-gray-300 items-center px-4 py-3 border-b">
                <div className="text-black md:w-1/3 text-xs md:text-md">E-mail</div>
                <div className="text-black md:w-1/3 text-xs md:text-md">{user.email}</div>
                {/* <div className="w-1/3 flex justify-end items-center">
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between  items-center px-4 py-3 border-b">
                <div className="text-black md:w-1/3 text-xs md:text-md">Password</div>
                <div className="text-black md:w-1/3 text-xs md:text-md">********</div>
                {/* <div className="w-1/3 flex justify-end items-center">
                <button
        ...
        <div className="text-md md:text-xl mb-4 md:mb-1 font-bold">Subscription plan</div>
        <div onClick={() => router.push(`/user-profile/subscription`)} className="text-md text-center md:text-start cursor-pointer px-2 py-1 md:px-8 md:py-2 bg-webred text-white rounded-lg hover:bg-[#f46379ec]">Buy More credits</div>
        </div>
