...
const PlaceOrder = () =>
{
  ...
  return (
    ...
    {
      loader && <div className="flex justify-center items-center min-h-screen"><Spinner/></div>
    }
    {
      !loader && cart.length === 0 && <div className="flex justify-center items-center min-h-screen"><h1 className="text-2xl font-bold mb-4">Cart is Empty</h1></div>
    }
    {
      !loader && cart.length > 0 && <div className="relative overflow-x-auto shadow-md rounded-lg">
          <table className="w-full text-sm text-left rtl:text-right text-black ">
              ...
              { cart?.map( ( item, index: number ) => (
                 ...
                 { item?.productId.mediaType === "image" && (
                    ...
                    <div className="md:w-2/3 overflow-hidden">
                      <div className="flex flex-col justify-start items-start ">
                        <div className="text-md font-bold">
                          { limitWords(item?.productId.title?.toUpperCase(),4)  }
                        </div>
                        <div className="mb-1 w-full">
                        <p className="text-md text-gray-600 description-truncate text-wrap">{ item?.productId.description }</p>
                        </div>
                    ...
                    >
                      <div className="text-md font-semibold">Buy with credits</div>
                    </span>
                    <span
