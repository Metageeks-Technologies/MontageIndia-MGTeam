...
const Sidebar = () => {
  ...
  const toggleProductMenu = () => {
    ...
    setIsUserOpen(false);  // Close User menu if Product menu is opened
  };

  const toggleUserMenu = () => {
    setIsUserOpen(!isUserOpen);
    setIsProductOpen(false);  // Close Product menu if User menu is opened
  };
  ...
  const handleAvailable = () => {
    router.push(`product/available`);
  };

  const handleunavailable = () => {
    router.push(`product/unavailable`);
  };

  const handleunarchive = () => {
    router.push(`product/archive`);
  };
          ...
          <nav className="mt-2">
            ...
            <ul>
              ...
              <li className="mb-1 px-4 py-2 hover:bg-gray-200 flex justify-between items-center">
                ...
                <button onClick={toggleProductMenu} className="focus:outline-none">
                  {isProductOpen  ? (
              ...
              {isProductOpen  && (
                <ul className="pl-8">
                  <li
                    ...
                    className="mb-1 px-4 py-2 hover:bg-gray-200 cursor-pointer"
                  >
                    Available
                  </li>
                  <li className="mb-1 px-4 py-2 hover:bg-gray-200 cursor-pointer">
                    draft
                  </li>
                  <li
              ...
              {isUserOpen && (
                <ul className="pl-8">
                  <li className="mb-1 px-4 py-2 hover:bg-gray-200 cursor-pointer">User List</li>
                  <li className="mb-1 px-4 py-2 hover:bg-gray-200 cursor-pointer">User Create</li>
                </ul>
              )}
