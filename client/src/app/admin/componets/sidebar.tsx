...
const Sidebar = () =>
{
  ...
  return (
    <div className="flex">
      ...
      <aside id="sidebar-multi-level-sidebar" className="fixed md:w-[20%] sm:w-[20%] hidden sm:block top-0 left-0 z-40 min-h-screen bg-gray-700" aria-label="Sidebar">
        <div className="h-screen px-1 py-2 overflow-y-auto bg-[#ececed] flex flex-col justify-between items-center gap-4">
          ...
          <div></div>
          <div className="border-t bg-white px-2 py-4 mt-5 rounded-md">
