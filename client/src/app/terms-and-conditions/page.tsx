...
const TermsAndConditions: React.FC = () =>
{
    return (
        <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <Head>
                <title>Terms and Conditions - Your E-commerce Store</title>
                <meta name="description" content="Terms and Conditions for Your E-commerce Store" />
            </Head>
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div className="px-4 py-5 sm:p-6">
                        ...
                        <h2 className="text-xl font-semibold mb-4">4. Pricing and Availability</h2>
                        <p className="mb-4">
                        ...
                        <p className="mb-4">
                            Shipping and delivery times may vary. We are not responsible for delays outside our control.
                        </p>
