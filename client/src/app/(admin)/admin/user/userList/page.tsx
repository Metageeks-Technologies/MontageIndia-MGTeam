  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await instance.get(`auth/admin/getAllAdmin`, {
        params: { searchTerm, currentPage, dataPerPage, roleSearch },
        ...
        <div className="flex items-center space-x-2 mb-4">
          ...
          <div className="flex items-center flex-wrap gap-4 ">
            ...
            <div>
              <select
                className="border rounded px-4 py-2"
                onChange={(e) => handleDataperPage(e)}
                value={dataPerPage}
              >
                  ...
                  allAdmins.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 hidden md:table-cell">
                        {user.mediaType && user.mediaType.length > 0
                      ...
                      <td className="px-4 py-4 border-b border-gray-200 bg-white">
                        <div className="flex justify-center items-center space-x-2">
                          <Link
                            href={`/admin/user/userList/${user._id}`}
