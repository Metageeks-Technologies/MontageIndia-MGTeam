  ...
  useEffect(() => {
    ...
    function randomRotate() {
      ...
      if (products.length > 0) {
        ...
        products[randomNumber].setAttribute(
          "data-orientation",
          JSON.stringify(newOrientation)
        );
...
const Cube = ({
  ...
  return (
    ...
    >
      <div className="cubeFace cubeFaceFront">{data.front}</div>
      <div className="cubeFace cubeFaceBack">{data.back}</div>
