  ...
  return (
    <div className="flex">
      ...
      <aside
        ...
        className="fixed w-full md:w-[20%] sm:w-[20%] hidden sm:block top-0 left-0 z-40 min-h-screen bg-gray-700"
        aria-label="Sidebar"
      >
            ...
            <ul className="space-y-2 font-medium">
              <li
                ...
                className={`cursor-pointer ${
                  isActiveLink("/admin/dashboard") ? "bg-gray-100" : ""
                }`}
              >
                ...
                <li>
                  ...
                  {isProductOpen && (
                    <ul className="py-2 space-y-2">
                      <li>
                        <Link
                          ...
                          className={`flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 cursor-pointer ${
                            isActiveLink("/admin/product/available")
                              ? "bg-white"
                              : ""
                          }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/admin/product/archive"
                          className={`flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 cursor-pointer ${
                            isActiveLink("/admin/product/archive")
                              ? "bg-white"
                              : ""
                          }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/admin/product/unavailable"
                          className={`flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 cursor-pointer ${
                            isActiveLink("/admin/product/unavailable")
                              ? "bg-white"
                              : ""
                          }`}
                        >
                    ...
                    <ul className="py-2 space-y-2">
                      <li>
                        <Link
                          href="/admin/user/userList"
                          className={`flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 cursor-pointer ${
                            isActiveLink("/admin/user/userList")
                              ? "bg-white"
                              : ""
                          }`}
                        >
                      ...
                      <li>
                        <Link
                          ...
                          className={`flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 cursor-pointer ${
                            isActiveLink("/admin/user/user-create")
                              ? "bg-white"
                              : ""
                          }`}
                        >
                      ...
                      <li>
                        <Link
                          href="/admin/user/user-activity"
                          className={`flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 cursor-pointer ${
                            isActiveLink("/admin/user/user-activity")
                              ? "bg-white"
                              : ""
                          }`}
                        >
