  ...
  <>
      ...
      <div role="status" className='justify-center h-screen flex items-center m-auto'>
        ...
        <div className='flex gap-3 flex-row'>
              ...
              <span className='font-semibold text-lg text-gray-600'>{data.title}</span>
            </div>
          ...
          <div className='justify-between flex w-auto gap-5'>
            <button onClick={handleSubmit}  className={`p-2 px-3 w-28 font-semibold text-white rounded-lg ${
