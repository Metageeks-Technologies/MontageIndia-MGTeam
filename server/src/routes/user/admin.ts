...
import {
  ...
  getTotalRevenueTrends,
  getSubscriptionPlanTrends,
  getOrderTrends,
...
adminRouter
  ...
  .patch(isAuthenticatedAdmin, updateAdminDetails);
adminRouter
  .route("/changePassword")
  .patch(isAuthenticatedAdmin, changePassword);
adminRouter.route("/forgetPassword").post(forgetPassword);
adminRouter.route("/resetPassword").post(resetPassword);
adminRouter.route("/siteData").get(getSiteData);
adminRouter.route("/userRegistrationTrendsp").get(getOrderTrends);
adminRouter.route("/userRegistrationTrends").get(getUserRegistrationTrends);
adminRouter.route("/totalRevenueTrends").get(getTotalRevenueTrends);
...
// activity route
adminRouter
  .route("/Activity/getAllActivity")
  .get(isAuthenticatedAdmin, getActivity);
adminRouter
  .route("/Activity/clearActivity")
  .delete(isAuthenticatedAdmin, clearActivity);
