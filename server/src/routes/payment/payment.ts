...
import { getTransactions, paymentVerify } from "@src/controller/payment/payment";
...
// webHook
paymentRouter.route('/webhook').post(bodyParser.raw({ type: 'application/json' }),paymentWebHook);
